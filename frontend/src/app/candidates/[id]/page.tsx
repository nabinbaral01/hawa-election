    ...
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-slate-900">{candidate.candidate_name}</h1>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm mt-6">
          <h3 className="font-semibold text-slate-900 mb-4">{t.competitors} in {candidate.const_name}</h3>
                  ...
                  >
                    ...
                    <td className="py-3 px-2">
                      <Link href={`/candidates/${c.id}`} className="font-medium text-slate-900 hover:text-red-600">
                        {c.candidate_name}
                        {c.id === candidate.id && <span className="ml-2 text-xs text-red-500">(current)</span>}
                      </Link>
                    </td>
